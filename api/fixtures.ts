...
const run = async () => {
  ...
  const [vac1, vac2, vac3, vac4, vac5, vac6] = await Vacancy.create(
      ...
      },
      {
        ...
        aboutVacancy: 'We are looking for a creative Marketing Specialist to help us grow our brand. The ideal candidate will have experience in digital marketing and a passion for brand development. You will be responsible for developing and executing marketing campaigns.',
        responsibilities: 'Develop and execute marketing campaigns. Analyze market trends and customer behavior. Create content for social media and other marketing channels. Collaborate with the sales team to develop lead generation strategies.',
        workConditions: 'Full-time position. Office-based role with occasional remote work options. Competitive salary and benefits.',
        country: 'Russia',
      ...
      },
      {
        ...
        city: 'Kazan',
        aboutVacancy: 'We are seeking a detail-oriented Data Analyst to join our team. The ideal candidate will have experience in data analysis and a strong analytical mindset. You will be responsible for analyzing large data sets to provide insights and recommendations.',
        responsibilities: 'Analyze large data sets to provide insights and recommendations. Develop and maintain data dashboards. Collaborate with cross-functional teams to identify data needs. Present findings to stakeholders.',
        workConditions: 'Full-time position. Flexible working hours. Remote work options available. Competitive salary and benefits.',
        country: 'Russia',
      ...
      },
      {
        ...
        city: 'Novosibirsk',
        aboutVacancy: 'We are looking for an experienced HR Manager to join our team. The ideal candidate will have experience in human resources and a passion for employee development. You will be responsible for managing HR functions and developing HR strategies.',
        responsibilities: 'Manage HR functions. Develop and implement HR strategies. Oversee recruitment and onboarding processes. Ensure compliance with labor laws and regulations.',
        workConditions: 'Full-time position. Office-based role with occasional remote work options. Competitive salary and benefits.',
        country: 'Russia',
      ...
      },
      {
        ...
        city: 'Yekaterinburg',
        aboutVacancy: 'We are seeking a creative Graphic Designer to join our team. The ideal candidate will have experience in graphic design and a strong portfolio. You will be responsible for creating visual content for various marketing materials.',
        responsibilities: 'Create visual content for marketing materials. Develop and maintain brand guidelines. Collaborate with the marketing team to create engaging content. Ensure all designs are on-brand and visually appealing.',
        workConditions: 'Full-time position. Flexible working hours. Remote work options available. Competitive salary and benefits.',
        country: 'Russia',
        fieldOfWork: 'Design',
        age: {
      ...
      },
      {
        ...
        city: 'Rostov-on-Don',
        aboutVacancy: 'We are looking for an experienced Project Manager to join our team. The ideal candidate will have experience in project management and a strong organizational mindset. You will be responsible for overseeing projects from inception to completion.',
        responsibilities: 'Oversee projects from inception to completion. Develop project plans and timelines. Coordinate with cross-functional teams. Ensure projects are completed on time and within budget.',
        workConditions: 'Full-time position. Flexible working hours. Remote work options available. Competitive salary and benefits.',
        country: 'Russia',
