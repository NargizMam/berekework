...
import { selectVacancy, selectVacancyLoading } from "../../../../admin/page/vacancyPanel/model/vacancySlice";
import { getVacancyById } from "../../../../admin/page/vacancyPanel/api/vacancyThunk";
