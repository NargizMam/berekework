...
export const fetchApplicants = createAsyncThunk<Applicant[]>('applicant/fetchAll', async () => {
  const response = await axiosApi.get<Applicant[]>(`/applicants`);
  return response.data;
});

export const fetchApplicant = createAsyncThunk<Applicant[], string>('applicant/fetchOne', async (userId) => {
...
export const deleteApplicant = createAsyncThunk<null, string>('applicant/delete', async (_id: string) => {
  await axiosApi.delete(`/applicants/${_id}`);
  return null;
});

export const activateApplicant = createAsyncThunk<null, string>('applicant/publish', async (_id: string) => {
