      ...
      <form style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }} autoComplete="off"
        ...
        <div className="formContainer">
          ...
          <Grid item xs>
            ...
            <input className="field" id="patronymic" value={state.patronymic} onChange={inputChangeHandler}
                   name="patronymic" />
          </Grid>
          <div className="inputContainer">
            <Grid item xs={7}>
            ...
            <Grid item xs>
              ...
              <input type={'date'} className="field" id="dateOfBirth" value={state.dateOfBirth}
          ...
          <div className="inputContainer">
            ...
            <Grid item xs>
              ...
              <select className="applicantField" id="city" value={state.city} onChange={inputChangeHandler} name="city"
                      required>
