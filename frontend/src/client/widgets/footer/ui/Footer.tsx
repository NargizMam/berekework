      ...
      <div className="container">
        <div className="footer-top">
          ...
          <div>
            ...
            <nav className="footer-nav">
              <li className="footer-nav-item">
                <a className="footer-nav-link">Наша компания</a>
              </li>
              <li>
                <a className="footer-nav-link">О нас</a>
              </li>
              <li className="footer-nav-item">
                <a className="footer-nav-link">Наши ценности</a>
              </li>
              <li className="footer-nav-item">
                <a className="footer-nav-link">Из преимуществ</a>
              </li>
              <li className="footer-nav-item">
                <a className="footer-nav-link">Наши сотрудники</a>
              </li>
              <li className="footer-nav-item">
                <a className="footer-nav-link">Галерея</a>
              </li>
              <li className="footer-nav-item">
                <a className="footer-nav-link">Видео</a>
              </li>
            </nav>
          </div>
          <div>
            ...
            <nav className="footer-nav">
              <li className="footer-nav-item">
                <a className="footer-nav-link">Все вакансии</a>
              </li>
            </nav>
          </div>
          <div>
            ...
            <nav className="footer-nav">
              <li className="footer-nav-item">
                <a className="footer-nav-link">Ищешь работника</a>
              </li>
              <li className="footer-nav-item">
                <a className="footer-nav-link">Тарифы</a>
              </li>
            </nav>
          </div>
        </div>
